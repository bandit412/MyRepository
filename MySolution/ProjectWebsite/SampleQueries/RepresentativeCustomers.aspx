...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <asp:ObjectDataSource ID="RepCustomerODS" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="RepresentativeCustomers_Get" TypeName="ChinookSystem.BLL.CustomerController">
        <SelectParameters>
            <asp:ControlParameter ControlID="EmployeeList" PropertyName="SelectedValue" Name="employeeId" Type="Int32" />
        </SelectParameters>
    ...
    &nbsp;&nbsp;<asp:Button ID="SubmitQuery" runat="server" Text="Fetch Customers" />
    <br />
    <br />
